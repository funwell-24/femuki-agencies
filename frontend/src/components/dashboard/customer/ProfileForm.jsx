// src/components/dashboard/customer/ProfileForm.jsx
import { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import { FiUser, FiMail, FiPhone, FiSave, FiEdit2, FiCamera, FiLoader } from 'react-icons/fi';
...
const ProfileForm = () => {
  ...
  const validateForm = () => {
    ...
    else if (!/^[0-9]{10,12}$/.test(profile.phone.replace(/\D/g, ''))) {
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              {isEditing && (
                <label className="absolute -bottom-2 -right-2 bg-primary-500 p-2 rounded-full cursor-pointer hover:bg-primary-600 transition-colors">
            ...
            <div>
              <h2 className="text-white text-xl font-semibold">{profile.fullName || 'Your Name'}</h2>
