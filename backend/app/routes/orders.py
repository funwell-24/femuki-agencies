...
def create_order():
    ...
    try:
        ...
        send_sms(user.phone, f"Order #{order.order_number} has been placed successfully. Total: KSH {order.total_amount:,.0f}")
...
def update_order_status(order_id):
    ...
    try:
        send_order_status_update(order.user.email, order, new_status, notes)
    except Exception as e:
